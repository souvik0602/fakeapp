...
let selectedFileInput2 = null;
let selectedFileInput3 = null;
...
async function uploadImage() {
    ...
    switch (selectedFileInput) {
        ...
        case 'fileInput1':
            url = '/proxy/upload-img-forge/';
            resultDiv.textContent = "Processing...";
            break;
        case 'fileInput2':
            url = '/proxy/upload-img-df/';
            resultDiv.textContent = "Processing...";
            break;
        case 'fileInput3':
            url = '/proxy/upload_image/';
            resultDiv.textContent = "Processing...";
            break;
...
async function uploadVideo() {
    ...
    const fileInput = document.getElementById(selectedFileInput3);
    if (fileInput.files.length === 0) {
        resultDiv.textContent = "Please select a file.";
        return;
    }
